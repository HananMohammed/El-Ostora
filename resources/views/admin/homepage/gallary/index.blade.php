...
@section('content')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('admin.galleries')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.galleries.index')}}" class="text-muted">@lang('admin.galleries')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Subheader-->
    @include('admin.homepage.gallary.form_store')
    <!--begin::Entry-->
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">@lang('admin.galleries')</h3>
                    </div>
                                    ...
                                    @if(count($galleries)>0)
                                        ...
                                        @foreach($galleries as $gallery)
                                            <tr>
                                                <td>{{$gallery->id}}</td>
                                                <td>{{$gallery->title}}</td>
                                                <td><img src="{{asset_public('storage/uploads/'.$gallery->image)}}" style="width: 100px;height: 60px;"></td>
                                                <td>{{$gallery->user()->pluck('name')[0]}}</td>
                                                <td nowrap="nowrap">{{ $gallery->id }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    @endif
            ...
            <span></span>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return `
            <a href="${currentLocation}/galleries/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
